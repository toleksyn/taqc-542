...
class NaturalNumberTest {
    ...
    private static Stream<Arguments> dataProvider_NaturalDividers_PositiveCases() {
        String dataSourcePath = NaturalNumberTest.class.getResource("/getNaturalDividersPositiveCases.csv").getPath();
    ...
    private static Stream<Arguments> dataProvider_NaturalDividers_NegativeCases() {
        String dataSourcePath = NaturalNumberTest.class.getResource("/getNaturalDividersNegativeCases.csv").getPath();
        return getVariableSizedListOfTestParameters(dataSourcePath);
    }
    ...
    private static Stream<Arguments> dataProvider_SimpleNaturalDividers_PositiveCases() {
        String dataSourcePath = NaturalNumberTest.class.getResource("/getSimpleNaturalDividersPositiveCases.csv").getPath();
        return getVariableSizedListOfTestParameters(dataSourcePath);
    }
    ...
    private static Stream<Arguments> dataProvider_SimpleNaturalDividers_NegativeCases() {
        String dataSourcePath = NaturalNumberTest.class.getResource("/getSimpleNaturalDividersNegativeCases.csv").getPath();
        return getVariableSizedListOfTestParameters(dataSourcePath);
    }
